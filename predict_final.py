...
# Break the brain into a voxel grid.
grid_size = 3
params = {}
feature_function = fourier.fourier
fourier_train_feat, fourier_test_feat = feat.compute_grid_features(train_filenames, test_filenames, y, grid_size, 'fourier', feature_function, params, crop_size_str, cluster_run, cluster_username, pca_dim = 2, k_best = 2)

feature_function = hist.histogram
params = {'num_bins': 50}
hist_train_feat, hist_test_feat = feat.compute_grid_features(train_filenames, test_filenames, y, grid_size, 'hist', feature_function, params, crop_size_str, cluster_run, cluster_username, k_best = 3)

params = {'slices': 1}
feature_function = canny.canny_filter
canny_train_feat, canny_test_feat = feat.compute_grid_features(train_filenames, test_filenames, y, grid_size, 'canny', feature_function, params, crop_size_str, cluster_run, cluster_username, n_dim = 100)
